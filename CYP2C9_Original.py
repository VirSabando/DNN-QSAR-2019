...
from CYP2C9_10 import train, test, ev
...
ruta = "/home/viri/Modelos_Finales/CYP2C9/Originales/mod_7_o/"+str(semilla)+"/mod.ckpt"
ruta_pickles = "/home/viri/Modelos_Finales/CYP2C9/Originales/mod_7_o/Pickles/"
...
with tf.Session() as session:
	...
	to_dump = (p1, p2, p3, p4)
	pkl.dump(to_dump, open(ruta_pickles + "mod_7_o_weights_" +str(semilla)+ ".p", "wb"))
	# pkl.dump(to_dump, open(ruta_pickles + "mod_7_o_EV_weights_" +str(semilla)+ ".p", "wb"))
	...
	pkl.dump(lista_intervalos, open(ruta_pickles + "mod_7_o_tuples_" + str(semilla) + ".p", "wb"))
	# pkl.dump(lista_intervalos, open(ruta_pickles + "mod_7_o_EV_tuples_" + str(semilla) + ".p", "wb"))
...
from CYP3A4_copia import train_Activos_data, train_Inactivos_data, train, test, ev
...
ruta = "/home/viri/Modelos_Finales/CYP3A4/Ampliados/he_10/"+str(semilla)+"/he.ckpt"
ruta_pickles = "/home/viri/Modelos_Finales/CYP3A4/Ampliados/he_10/Pickles/"
...
with tf.Session() as session:
	...
	to_dump = (p1, p2, p3, p4)
	pkl.dump(to_dump, open(ruta_pickles + "he_10_weights_" +str(semilla)+ ".p", "wb"))
	# pkl.dump(to_dump, open(ruta_pickles + "he_10_EV_weights_" +str(semilla)+ ".p", "wb"))
	...
	pkl.dump(lista_intervalos, open(ruta_pickles + "he_10_tuples_" + str(semilla) + ".p", "wb"))
	# pkl.dump(lista_intervalos, open(ruta_pickles + "he_10_EV_tuples_" + str(semilla) + ".p", "wb"))

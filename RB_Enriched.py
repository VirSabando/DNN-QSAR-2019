...
from Todeschini import train_RB_data, train_NRB_data, train_data, test_data, ev
...
ruta = "/home/viri/Modelos_Finales/RB/Ampliados/mod_2/"+str(semilla)+"/sees.ckpt"
ruta_pickles = "/home/viri/Modelos_Finales/RB/Ampliados/mod_2/Pickles/"
...
with tf.Session() as session:
	...
	to_dump = (p1, p2, p3, p4)
	pkl.dump(to_dump, open(ruta_pickles + "mod_2_weights_" +str(semilla)+ ".p", "wb"))
	# pkl.dump(to_dump, open(ruta_pickles + "mod_2_EV_weights_" +str(semilla)+ ".p", "wb"))
	...
	pkl.dump(lista_intervalos, open(ruta_pickles + "mod_2_tuples_" + str(semilla) + ".p", "wb"))
	# pkl.dump(lista_intervalos, open(ruta_pickles + "mod_2_EV_tuples_" + str(semilla) + ".p", "wb"))